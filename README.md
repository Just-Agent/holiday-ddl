...
[![Status](https://img.shields.io/badge/Status-topic%20scaffold-64748B?style=for-the-badge)](https://github.com/Just-Agent/holiday-ddl)

[专题页面](https://just-agent.github.io/holiday-ddl/) · [Just-DDL 总入口](https://just-agent.github.io/just-ddl/) · [GitHub 仓库](https://github.com/Just-Agent/holiday-ddl) · [提交数据](https://github.com/Just-Agent/holiday-ddl/issues)

</div>

## 项目定位

Holiday-DDL 负责 中国法定节假日、调休、二十四节气、寒暑假、考试周与日常通用倒计时。它会作为独立仓库维护，拥有自己的 Pages 页面、数据 schema、Actions 更新流程和未来小程序专题入口。

## 产品入口

| 入口 | 地址 | 用途 |
| --- | --- | --- |
| GitHub Pages | https://just-agent.github.io/holiday-ddl/ | 专题独立页面 |
| Just-DDL Hub | https://just-agent.github.io/just-ddl/ | 全部 DDL 专题总入口 |
| Repository | https://github.com/Just-Agent/holiday-ddl | 代码、数据、工作流与贡献入口 |
| Issues | https://github.com/Just-Agent/holiday-ddl/issues | 补充截止日、修正链接、申请数据源 |
...
| 类别 | 示例 | 当前处理方式 |
| --- | --- | --- |
| 法定节假日 | 春节 / 国庆 / 劳动节 | 维护放假、调休、补班日期 |`n| 节气日历 | 二十四节气 | 维护年度节气时间 |`n| 校园节点 | 寒暑假 / 考试周 / 开学 | 后续支持学校和地区扩展 |
